...
- Name: track-creation.spec.ts >> GeoRun Dashboard >> logout clears session and redirects to /login
- Location: tests\track-creation.spec.ts:89:7
    ...
    - generic [ref=e10]:
      - generic [ref=e11]:
        ...
        - textbox "Email" [ref=e13]:
          ...
          - text: e2e-admin-1782715462033@georun.test
      - generic [ref=e14]:
