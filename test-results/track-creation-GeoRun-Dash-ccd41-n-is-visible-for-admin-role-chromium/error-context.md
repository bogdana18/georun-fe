...
- Name: track-creation.spec.ts >> GeoRun Dashboard >> New Track button is visible for admin role
- Location: tests\track-creation.spec.ts:95:7
    ...
    - generic [ref=e10]:
      - generic [ref=e11]:
        ...
        - textbox "Email" [ref=e13]:
          ...
          - text: e2e-admin-1782715478561@georun.test
      - generic [ref=e14]:
