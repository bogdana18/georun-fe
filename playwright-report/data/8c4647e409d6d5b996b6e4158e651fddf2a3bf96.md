...
- Name: track-creation.spec.ts >> GeoRun Dashboard >> dashboard loads with admin role badge after login
- Location: tests\track-creation.spec.ts:82:7
    ...
    - generic [ref=e10]:
      - generic [ref=e11]:
        ...
        - textbox "Email" [ref=e13]:
          ...
          - text: e2e-admin-1782715439695@georun.test
      - generic [ref=e14]:
