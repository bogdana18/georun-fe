...
- Name: track-creation.spec.ts >> GeoRun User Role (view-only) >> New Track button is NOT visible for regular users
- Location: tests\track-creation.spec.ts:162:7
    ...
    - generic [ref=e10]:
      - generic [ref=e11]:
        ...
        - textbox "Email" [ref=e13]:
          ...
          - text: e2e-user-1782715527950@georun.test
      - generic [ref=e14]:
